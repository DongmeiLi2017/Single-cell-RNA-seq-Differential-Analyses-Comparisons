...
for (j in 1:length(diffpro))
{
  ...
  while (num<=total)
  {
    ...
    simulateddata <- RnaXSim(expMatrix, distribution="NB", NumRep=trtsize, NumDiff = ndiff[j], NumFea = ngene)
    truev <- c(rep(0, ngene))
...
write.csv(meanFDR, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanFDR_DESeq2_n_100_propzero_NB_Islam2011.csv")
write.csv(meansen, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meansen_DESeq2_n_100_propzero_NB_Islam2011.csv")
write.csv(meanspe, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanspe_DESeq2_n_100_propzero_NB_Islam2011.csv")
write.csv(meanacu, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanacu_DESeq2_n_100_propzero_NB_Islam2011.csv")
write.csv(meanauc, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanauc_DESeq2_n_100_propzero_NB_Islam2011.csv")
