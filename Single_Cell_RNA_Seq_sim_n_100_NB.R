...
write.csv(meanFDR, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanFDR_DESeq2_n_100_propzero_NB.csv")
write.csv(meansen, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meansen_DESeq2_n_100_propzero_NB.csv")
write.csv(meanspe, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanspe_DESeq2_n_100_propzero_NB.csv")
write.csv(meanacu, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanacu_DESeq2_n_100_propzero_NB.csv")
write.csv(meanauc, file="D:/Box Sync/Conferences/Huston_2018/Simulation_Results/meanauc_DESeq2_n_100_propzero_NB.csv")
...
legend("topleft", c("DEsingle","Linnorm", "monocle", "MAST", "DESeq2"), cex=1.0,
