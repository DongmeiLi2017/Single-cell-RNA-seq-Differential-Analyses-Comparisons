...
write.csv(meanFDR, file="D:/Box Sync/Conferences/Huston_2018/meanFDR_DESeq2_n_5_propzero.csv")
write.csv(meansen, file="D:/Box Sync/Conferences/Huston_2018/meansen_DESeq2_n_5_propzero.csv")
write.csv(meanspe, file="D:/Box Sync/Conferences/Huston_2018/meanspe_DESeq2_n_5_propzero.csv")
write.csv(meanacu, file="D:/Box Sync/Conferences/Huston_2018/meanacu_DESeq2_n_5_propzero.csv")
write.csv(meanauc, file="D:/Box Sync/Conferences/Huston_2018/meanauc_DESeq2_n_5_propzero.csv")


colnames(meanFDR) <- colnames(meansen) <- colnames(meanspe) <- colnames(meanacu) <- colnames(meanauc) <- c("DEsingle", "Linnorm", "monocle", "MAST", "DESeq2")
...
boxplot(meanFDR, col=c("blue","red", "darkgreen", "cyan", "orange"), xlab=NULL, ylab="FDR", las=2)
boxplot(meansen, col=c("blue","red", "darkgreen", "cyan", "orange"), xlab=NULL, ylab="Sensitivity", las=2)
boxplot(meanspe, col=c("blue","red", "darkgreen", "cyan", "orange"), xlab=NULL, ylab="Specificity", las=2)
boxplot(meanacu, col=c("blue","red", "darkgreen", "cyan", "orange"), xlab=NULL, ylab="accuracy", las=2)
dev.off()

par(mfrow=c(1, 1), mar=c(8,6,2,2)+0.1, mgp=c(4, 1, 0), cex=1.0)
boxplot(meanauc, col=c("blue","red", "darkgreen", "cyan", "orange"), xlab=NULL, ylab="AUC", las=2)
dev.off()
