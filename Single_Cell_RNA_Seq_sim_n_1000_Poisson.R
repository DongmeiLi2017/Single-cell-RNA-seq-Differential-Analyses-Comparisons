...
write.csv(meanFDR, file="D:/Box Sync/Conferences/Huston_2018/meanFDR_DESeq2_n_100_propzero_Poisson.csv")
write.csv(meansen, file="D:/Box Sync/Conferences/Huston_2018/meansen_DESeq2_n_100_propzero_Poisson.csv")
write.csv(meanspe, file="D:/Box Sync/Conferences/Huston_2018/meanspe_DESeq2_n_100_propzero_Poisson.csv")
write.csv(meanacu, file="D:/Box Sync/Conferences/Huston_2018/meanacu_DESeq2_n_100_propzero_Poisson.csv")
write.csv(meanauc, file="D:/Box Sync/Conferences/Huston_2018/meanauc_DESeq2_n_100_propzero_Poisson.csv")
